...
Both models capture \textbf{long-term growth explicitly}---why classical time-series beats tree/neural methods that cap at training range \cite{Hyndman2021}. The reliability evidence, validation protocol, data setting, and reproducibility controls are reported in the Appendix.
...
The Theta method decomposes $y_t$ into two theta lines \cite{Assimakopoulos2000}:
...
\begin{enumerate}
  \item \label{ref:Hyndman2021}
  Hyndman, R.~J., \& Athanasopoulos, G. (2021).
  \textit{Forecasting: Principles and Practice} (3rd ed.).
  OTexts.
  Available at: \url{https://otexts.com/fpp3/}

  \item \label{ref:Assimakopoulos2000}
  Assimakopoulos, V., \& Nikolopoulos, K. (2000).
  The Theta model: a decomposition approach to forecasting.
  \textit{International Journal of Forecasting}, \textbf{16}(4), 521--530.
  \href{https://doi.org/10.1016/S0169-2070(00)00066-2}{DOI: 10.1016/S0169-2070(00)00066-2}

  \item \label{ref:Bergmeir2014}
  Bergmeir, C., Ben\'itez, M., \& Artieda, J. (2014).
  On the use of cross-validation for time series forecasting evaluation.
  \textit{Information Sciences}, \textbf{191}, 192--213.
  \href{https://doi.org/10.1016/j.ins.2013.07.019}{DOI: 10.1016/j.ins.2013.07.019}

  \item \label{ref:Pedregosa2011}
  Pedregosa, F., Varoquaux, G., Gramfort, A., Michel, V., Thirion, B., Grisel, O., Blondel, M., M\"uller, A., Nothman, J., Gensollen, F., Payan, O., Nowak, W., Linder, D., Teytaud, O., \& Duchesnay, E. (2011).
  ...
  \item \label{ref:Harris2020}
  Harris, C.~R., Millman, K.~J., van der Walt, S.~J., Gommers, R., Virtanen, P., Cournapeau, D., Wieser, E., Taylor, J., Berg, S., Smith, N.~J., Kern, R., Picus, M., Hoyer, S., van Kerkwijk, M.~H., Brett, M., Haldane, A., del R\'io, J.~F., Wiebe, M., Peterson, P., \ldots G\'erard-Marchant, P. (2020).
  Array programming with NumPy.
  \textit{Nature}, \textbf{585}, 357--362.
  \href{https://doi.org/10.1038/s41586-020-2649-2}{DOI: 10.1038/s41586-020-2649-2}

  \item \label{ref:Makridakis2020}
  Makridakis, S., Spiliotis, E., \& Assimakopoulos, V. (2020).
  The M4 Competition: 100,000 time series and 61 forecasting methods.
  \textit{International Journal of Forecasting}, \textbf{36}(1), 54--74.
  \href{https://doi.org/10.1016/j.ijforecast.2019.12.011}{DOI: 10.1016/j.ijforecast.2019.12.011}
\end{enumerate}
